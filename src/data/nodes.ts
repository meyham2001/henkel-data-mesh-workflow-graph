import { PipelineNode } from './schema';
...
export const PIPELINE_NODES: PipelineNode[] = [
    ...
    "sampleData": {
      ...
      "rows": [
        ...
        [
          ...
          "Manual (mandatory QQ1)",
          "Absent in most products"
        ],
        [
          "Promised Freshness SLA",
          "Business commitment",
          "Manual sign-off",
          "No SLA declared"
        ],
        [
          ...
          "Semi-automated (ABAC tags)",
          "View DDL dev/prod split"
        ]
      ]
    },
    "versions": {
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "SAP ECC / BW",
          "P47 Extraction Pipeline",
          "Synapse (DWH) + CIN (Databricks)",
          "3-year commitment -> SAP BDC / BDC Connect"
        ],
        [
          "Salesforce / CRM",
          "Azure Data Factory (ADF)",
          "Databricks Zone 10 Raw",
          "Managed ADF REST API extraction"
        ],
        [
          "PIM / Product Data",
          "ADF SFTP / Blob Drop",
          "Databricks Zone 15 External",
          "Quarantined third-party feed"
        ],
        [
          "Synapse (Modelled)",
          "ADF Copy Pipeline",
          "Databricks (One-way feed)",
          "To be migrated to Databricks native logic"
        ]
      ]
    },
    "versions": {
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "QQ1: Named consumer who would notice absence?",
          "Every domain \u2014 functionally the same as no one",
          "FAIL"
        ],
        [
          "QQ2: Can owning team change without sign-off?",
          "No. Any SAP change impacts all consuming domains",
          "FAIL"
        ],
        [
          "QQ3: Does whole thing change as a unit?",
          "No. Changes whenever any source system changes",
          "FAIL"
        ],
        [
          "QQ4: Would a consumer request it by name?",
          "No. Consumers request their domain data (e.g. Finance)",
          "FAIL"
        ]
      ]
    },
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "hdp_sales_dev.self_orders_raw",
          "sap_vbrk_20260910.parquet",
          "Batch hourly append",
          "Raw payload, unmodified byte-for-byte"
        ],
        [
          "hdp_mkt_dev.external_vendor_raw",
          "campaign_leads_export.csv",
          "External vendor drop",
          "Quarantined third-party feed, raw strings"
        ],
        [
          "hdp_rnd_dev.self_lab_raw",
          "lims_test_results.json",
          "Event stream",
          "Unparsed JSON telemetry audit trail"
        ]
      ]
    },
    "versions": {
    ...
    "sampleData": {
      ...
      "rows": [
        ...
        [
          ...
          "sap_plant_id",
          "STRING",
          "Master plant standard conformed"
        ]
      ]
    },
    "versions": {
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "shared_orders_curated.customer_orders_def_def",
          "shared_ publish view",
          "v1.0 (ODCS in Git)",
          "Certified (CERT-1..5 met)"
        ],
        [
          "shared_material_curated.material_dim_def_def",
          "shared_ publish view",
          "v2.1 (ODCS in Git)",
          "Certified (Master Data)"
        ],
        [
          "self_orders_enriched.campaign_efficiency",
          "self_ internal table",
          "None",
          "Registered (Internal only)"
        ]
      ]
    },
    "versions": {
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "source_cma_material_curated",
          "material_dim",
          "hdp_cma_dev.shared_material_curated",
          "View (live SQL resolution)"
        ],
        [
          "source_csc_def_curated",
          "customer_dim",
          "hdp_csc_dev.shared_def_curated",
          "View (live SQL resolution)"
        ],
        [
          "source_sbi_def_curated",
          "sales_benchmark",
          "hdp_sbi_dev.shared_def_curated",
          "View (live SQL resolution)"
        ],
        [
          "source_cma_shared_curated",
          "companycode2_dim",
          "hdp_cma_dev.shared_company_curated",
          "View (live SQL resolution)"
        ]
      ]
    },
    ...
    "sampleData": {
      ...
      "rows": [
        [
          ...
          "Aggregated monthly dimensional grain",
          "Unrestricted Internal"
        ],
        [
          "customer_order_history_serving",
          "CRM Sales Representative App",
          "Denormalised customer history",
          "PII Masked Tier"
        ],
        [
          "supply_chain_plant_efficiency",
          "Logistics Operations Portal",
          "Pre-computed KPIs and variance",
          "Business Cleared"
        ]
      ]
    },
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "Technical Lineage",
          "Populated",
          "Databricks, Power BI, SAP, DWH",
          "Shows connections, not guarantees"
        ],
        [
          "Business Glossary",
          "Rolling out",
          "Enterprise-wide",
          "Only a handful of terms populated"
        ],
        [
          "Data Marketplace",
          "Early stage",
          "Databricks catalogs",
          "No consumer quality/freshness signals"
        ],
        [
          "Search Functionality",
          "Active",
          "Cross-platform metadata",
          "Discovers tables, not business definitions"
        ]
      ]
    },
    "versions": {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          ...
          "Per user attribute / AD role"
        ],
        [
          "New PII Column Addition",
          "Requires view DDL edit & redeploy",
          "Tag column once; inherits policy"
        ],
        [
          "Auditability",
          "Inspect DDL across all views",
          "Query centralized policy rules"
        ],
        [
          "Prod PII Protection",
          "Table / schema grants only",
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "Power BI Executive Apps",
          "Business Leadership",
          "Competing against trusted DWH (H10)",
          "Perceived benefit / trust"
        ],
        [
          "Ad Hoc Self-Service",
          "Financial / Sales Analysts",
          "No semantic layer or NL access (AI-C1)",
          "Speed of query answer"
        ],
        [
          "Legacy DWH (Synapse)",
          "Enterprise Reporting",
          "Active system running in parallel",
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "columns": [
        ...
        "Target State",
        "Current Henkel Reality",
        "Incident Impact"
      ],
      "rows": [
        [
          "Pipeline Break Detection",
          "Automated job alert & error isolation",
          "Manual step-by-step tracing",
          "High engineer MTTR"
        ],
        [
          "Freshness SLA Monitoring",
          "Automated breach notification (G2)",
          "No monitoring; user complains",
          "Silent data staleness"
        ],
        [
          "Incident Event Architecture",
          "Structured machine-readable events (P2)",
          "Unstructured emails / none",
          "Blocks AI agent automation"
        ],
        [
          "Consumer Notification",
          "Automated push to downstream users",
          "Absent",
          "Broken dashboard cascades"
        ]
      ]
    },
    "versions": {
  ...
  },
  {
    ...
    "sampleData": {
      ...
      "rows": [
        ...
        [
          "Breaking Change",
          "Notice period + semantic major bump",
          "Consumer registry impact analysis",
          "Missing (G6)"
        ],
        [
          "Retirement / Sunset",
          "Identify active consumers & decommission",
          "Usage query audit & sign-off",
          "Missing (G7)"
        ]
      ]
    },
    ...
    "sampleData": {
      ...
      "rows": [
        ...
        [
          ...
          "Inside Databricks",
          "No",
          "Product namespace (hdp_{product}_{env})"
        ],
        [
          "Schema",
          "Inside Databricks",
          "No",
          "Zone representation (10-Raw..50-Serving)"
        ],
        [
          "Delta Table",
          "Inside Databricks storage",
          "Yes (Parquet + _delta_log)",
          "Stateful data storage"
        ],
        [
          "Shared View",
          "Inside Databricks metadata",
          "No (SQL query text)",
          "Zero-copy live mirror endpoint"
        ]
      ]
    },
    "versions": {
    ...
    "sampleData": {
      ...
      "rows": [
        [
          ...
          "Henkel Data Hub",
          "Early rollout",
          "Discovery surface, not control plane"
        ],
        [
          "End-to-End Lineage",
          "Henkel Data Hub",
          "Populated across Databricks, SAP, DWH",
          "Technical lineage ingestion"
        ],
        [
          "Business Glossary",
          "Henkel Data Hub",
          "Near-empty (handful of terms)",
          "Meaning & definitions surface"
        ],
        [
          "Search Functionality",
          "Henkel Data Hub",
    ...
    "sampleData": {
      ...
      "rows": [
        [
          "Negotiated Promise",
          "Git (Azure DevOps)",
          "Needs diff, PR review before changes ship, and CI validation",
          "YAML (ODCS)"
        ],
        [
          "Runtime Metadata",
          "Unity Catalog",
          "Visible to consumers browsing Catalog Explorer",
          "Comments, Tags, Constraints"
        ],
        [
          "Runtime Freshness Check",
          "Databricks Job / DLT",
          "Git cannot enforce SLAs at runtime; needs monitoring",
    ...
    "sampleData": {
      ...
      "rows": [
        [
          ...
          "Standards & taxonomy documentation"
        ],
        [
          "Execution & Automation",
          "Data Architecture / DxD",
          "Automates how rules are followed",
          "Templates, CI, ABAC policies"
        ],
        [
          "Meaning & Lineage Display",
          "DataHub Team",
